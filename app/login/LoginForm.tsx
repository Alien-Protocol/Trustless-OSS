    ...
    <div className="flex flex-1 items-center justify-center p-6">
      <div className="surface-card relative w-full max-w-md p-8 md:p-10">
        <button
          type="button"
          onClick={() => router.back()}
          className="absolute top-4 right-4 flex h-9 w-9 items-center justify-center rounded-full bg-slate-100 text-slate-700 transition hover:bg-slate-950 hover:text-white"
          aria-label="Go back"
        >
          <X size={18} strokeWidth={2.25} />
        </button>

        <p className="text-xs font-semibold tracking-[0.18em] text-blue-600 uppercase">Sign in</p>
        <h1 className="font-display mt-3 text-3xl font-extrabold tracking-tight text-slate-950">
          Authenticate
        </h1>
